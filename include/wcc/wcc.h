...
namespace scd 
{
	...
	double64_t 	ComputeWCC(const CGraph * graph, std::vector <uint32_t>&communities, const uint32_t numCommunities,
	                       const uint32_t* labelsIndices, const uint32_t * communitiesInvIndex, double64_t* wccs,
