...
int main(int argc, char ** argv) {
    ...
    for (uint32_t i = 1; i < argc; i++) {
        ...
        CHECK_ARGUMENT_INT(i, "-s", semiTriangle, semiTriangleSet)
    }
    ...
    initTime = StartClock();
    if (ImproveCommunities(&graph, &partition, numThreads, semiTriangle)) {
